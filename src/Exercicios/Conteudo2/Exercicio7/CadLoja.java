...
public class CadLoja {
    ...
    public static void main(String[] args){
        try{
            ...
            saida = new BufferedWriter (new FileWriter ("C:/Users/marco/Desktop/ESTRUTURA DE DADOS/Arquivos/Roupa.txt", true));
        ...
        System.out.println ("Digite a Roupa");
            ...
            System.out.println ("Digite seus Cor");
            String Cor = entrada.readLine();
            System.out.println ("Digite seu Modelo");
            String Modelo = entrada.readLine();
            RegLoja regProd = new RegLoja(Roupa, Tamanho, Cor, Modelo); // cria o registro no arquivo agenda

            saida.write(regProd.getRoupa()+"\t"); // \t” é similar a apertar “tab” do teclado e cria um espaçamento
            saida.write(regProd.getTamanho()+"\t");
            saida.write(regProd.getCor()+"\t");
            saida.write(regProd.getModelo()+"\n");
