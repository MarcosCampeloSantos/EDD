...
public class CadAluno {
    ...
    public static void main(String[] args){
        try{
            ...
            saida = new BufferedWriter (new FileWriter ("C:/Users/marco/Desktop/ESTRUTURA DE DADOS/Arquivos/Aluno.txt", true));
        ...
        System.out.println ("Digite o Aluno");
            ...
            RegAluno regProd = new RegAluno(Aluno, Curso, Turma, Periodo); // cria o registro no arquivo agenda

            saida.write(regProd.getAluno()+"\t"); // \t” é similar a apertar “tab” do teclado e cria um espaçamento
            saida.write(regProd.getCurso()+"\t");
            saida.write(regProd.getTurma()+"\t");
            saida.write(regProd.getPeriodo()+"\n");
