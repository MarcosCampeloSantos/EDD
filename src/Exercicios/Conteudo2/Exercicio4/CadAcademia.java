...
public class CadAcademia {
    ...
    public static void main(String[] args){
        try{
            ...
            saida = new BufferedWriter (new FileWriter ("C:/Users/marco/Desktop/ESTRUTURA DE DADOS/Arquivos/Academia.txt", true));

        System.out.println ("Digite a Academia");
            String Academia = entrada.readLine();
            System.out.println ("Digite a Atividade");
            String Atividade = entrada.readLine();
            System.out.println ("Digite seu Aparelho");
            ...
            RegAcademia regProd = new RegAcademia(Academia, Atividade, Aparelho, Horario, Dia); // cria o registro no arquivo agenda

            saida.write(regProd.getAcademia()+"\t"); // \t” é similar a apertar “tab” do teclado e cria um espaçamento
            saida.write(regProd.getAtividade()+"\t");
            saida.write(regProd.getAparelho()+"\t");
